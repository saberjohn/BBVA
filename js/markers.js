//set markers from customer zipcodes
function setMarkers(d, ZipCode) {
	...
	//var color_x = new Array('#D6E3F1', '#6DA5D1', '#3267B0', '#122A42');
	...
	jQuery.each(d.zcs, function(zp, data) {
		...
		if(lat != 0) {
			marker = L.circle([lat, lng], 200, {
				data : data,
				zp   : zp,
				fillOpacity: 0.7, 
				opacity: 0.7, weight: 1.2, color: "#223346", fillColor: color_x[getClass(data[graphType], ranges)]
			});
